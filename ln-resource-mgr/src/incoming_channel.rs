...
impl IncomingChannel {
    pub(super) fn new(
        ...
        Self {
            params,
            reputation: DecayingAverage::new(
    ...
    pub(super) fn reputation(&mut self, access_instant: Instant) -> Result<i64, ReputationError> {
        self.reputation.value_at_instant(access_instant)
    }
    ...
    pub(super) fn remove_incoming_htlc(
        ...
        self.reputation.add_value(effective_fees, resolved_ins)?;
...
mod tests {
    ...
    fn test_no_congestion_abuse() {
        ...
        let mut incoming_channel = IncomingChannel::new(
            params,
            // FIXME: putting these as placeholders for now. Just copied these from outgoing
            BucketParameters {
                slot_count: 100,
