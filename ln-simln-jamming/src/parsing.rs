...
/// Default file used to describe the reputation of the network.
const DEFAULT_REPUTATION_FILE: &str = "./reputation-snapshot.csv";
...
pub struct Cli {
    ...
    /// A CSV file containing the reputation values for the channels in the network.
    #[arg(long, default_value = DEFAULT_REPUTATION_FILE)]
...
pub fn calc_file_chunks(file_path: &PathBuf, num_chunks: u8) -> Result<Vec<u64>, BoxError> {
...
pub fn reputation_snapshot_from_file(
    ...
    for result in csv_reader.records() {
        ...
        let channel_capacity: u64 = record[2].parse()?;
